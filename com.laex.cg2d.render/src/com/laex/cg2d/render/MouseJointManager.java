 ...
 * 
 */
public class MouseJointManager extends AbstractGameComponentManager implements
		InputProcessor {
	...
	public MouseJointManager(CGGameModel model, World world, Camera cam) {
		...
		this.mouseJointInstalled = model.getScreenPrefs().getDebugDrawPrefs()
				.getInstallMouseJoint();
	}
	...
	public boolean touchDown(int x, int y, int pointer, int button) {
		...
		hitBody = null;
		world().QueryAABB(callback, testPoint.x - 0.0001f,
				testPoint.y - 0.0001f, testPoint.x + 0.0001f,
				testPoint.y + 0.0001f);
