...
public class ProtoBufTypeConversionUtil {
	 ...
	 * @param _jdef the _jdef
	 * @return the distance joint def
	 */
	public static DistanceJointDef asDistanceJointDef(Body bodyA, Body bodyB,
			CGDistanceJointDef _jdef) {
	 ...
	 */
	public static PulleyJointDef asPulleyJointDef(Body bodyA, Body bodyB,
			CGPulleyJointDef _jdef) {
		PulleyJointDef jdef = new PulleyJointDef();
		jdef.collideConnected = _jdef.getCollideConnected();
		jdef.ratio = _jdef.getRatio();
		jdef.initialize(bodyA, bodyB,
				ProtoBufTypeConversionUtil.asVector2(_jdef.getGroundAnchorA()),
				ProtoBufTypeConversionUtil.asVector2(_jdef.getGroundAnchorB()),
	 ...
	 */
	public static RevoluteJointDef asRevoluteJoint(Body bodyA, Body bodyB,
			CGRevoluteJointDef _jdef) {
	 ...
	 */
	public static FrictionJointDef asFrictionJointDef(Body bodyA, Body bodyB,
			CGFrictionJointDef _jdef) {
	 ...
	 */
	public static WeldJointDef asWeldJointDef(Body bodyA, Body bodyB,
			CGWeldJointDef _jdef) {
	 ...
	 */
	public static PrismaticJointDef asPrimasticJointDef(Body bodyA, Body bodyB,
			CGPrismaticJointDef _jdef) {
		...
		jdef.initialize(bodyA, bodyB,
				ProtoBufTypeConversionUtil.asVector2(_jdef.getAnchor()),
