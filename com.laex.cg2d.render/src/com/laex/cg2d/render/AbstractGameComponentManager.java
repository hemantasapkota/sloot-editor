 ...
 */
public abstract class AbstractGameComponentManager implements IGameComponentManager {
   ...
   *          the cam
   */
  public AbstractGameComponentManager(CGGameModel model, World world, Camera cam) {
    this.world = world;
    this.model = model;
    this.cam = cam;
